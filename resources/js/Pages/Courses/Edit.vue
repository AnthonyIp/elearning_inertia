                ...
                <form @submit.prevent="submit" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                    ...
                    <div v-for="(episode, index) in courseData.episodes" v-bind:key="index">
                        ...
                        <input
                            ...
                            :id="'episode-title-' + index" v-model="courseData.episodes[index].title"/>
                        ...
                        <input
                            ...
                            :id="'episode-description-' + index" v-model="courseData.episodes[index].description"/>
                        ...
                        <input
                            class="rounded shadow appearance-none w-full py-2 px-3 mb-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            :id="'episode-description-' + index" v-model="courseData.episodes[index].video_url"/>
                    ...
                    <div>
                        <button v-if="courseData.episodes.length < 15" @click.prevent="add"
                                class="bg-green-500 hover:bg-green-700 text-white font-bold my-3 py-2 px-4 rounded">
                            +
                        </button>
                        <button v-if="courseData.episodes.length > 1" @click.prevent="remove"
